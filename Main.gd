...
var att_per_level = 2 #how many towers are available in a level
var total_filaments = [200, 200, 0, 0] #given filaments at the start of the game
var tower_price = [100, 100, 0, 0] # price of each tower
