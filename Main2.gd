...
var att_per_level = 3 #how many towers are available in a level
var total_filaments = [200, 200, 200, 0] #given filaments at the start of the game
var tower_price = [100, 100, 200, 0] # price of each tower
...
func condition():
	if $Monsters.monsters_dead == $Monsters.monsters.size():
		get_tree().change_scene("res://NextLevel2.tscn")
